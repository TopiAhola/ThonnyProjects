...
########################################
    ...
    def kubios_menu1(self):
        ...
        print(header)
        oled.fill(0)
        oled.text("Collecting data.", 0, 32, 1)
        oled.show()
        
        time.sleep(self.cycle_time)
        
        
        # Insert Kubios fetch code
    ...
    def kubios_menu2(self):
        ...
        print(header)
        oled.fill(0)
        oled.text("Sending data.", 0, 32, 1)
        oled.show()
        
        time.sleep(self.cycle_time)
        
        # Insert Kubios send code
    ...
    def kubios_menu_error(self):
        header: str = "Kubios Menu Error"
        print(header)
        oled.fill(0)
        oled.text("Error sending", 0, 0, 1)
        oled.text("data!", 0, 9, 1)
        oled.text("Press the button", 0, 18, 1)
        oled.text("to retry", 0, 27, 1)
        oled.text(" ", 0, 36, 1)
        oled.text("Wait 3 seconds", 0, 45, 1)
